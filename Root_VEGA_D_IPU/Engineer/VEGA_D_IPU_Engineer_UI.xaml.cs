...
{
    /// <summary>
    /// VEGA_D_IPU_Engineer_UI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class VEGA_D_IPU_Engineer_UI : UserControl
    {
        public VEGA_D_IPU_Engineer_UI()
        {
            InitializeComponent();
        }

        VEGA_D_IPU_Engineer m_engineer = null;
        public void Init(VEGA_D_IPU_Engineer engineer)
        {
            m_engineer = engineer;
