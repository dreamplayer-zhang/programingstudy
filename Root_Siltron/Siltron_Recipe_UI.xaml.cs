...
{
    /// <summary>
    /// Siltron_Recipe_UI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class Siltron_Recipe_UI : UserControl
    {
        public Siltron_Recipe_UI()
        {
            InitializeComponent();
        }

        Siltron_Recipe m_recipe;
        ModuleRunList m_moduleRunList;
        public void Init(Siltron_Recipe recipe)
        {
