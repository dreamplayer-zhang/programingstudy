...
{
    public class Siltron_Process : NotifyProperty //forget
    {
...
//            }
        ...
        public Siltron_Handler m_handler;
//        Robot_RND m_robot;
        Log m_log;
        public TreeRoot m_treeWafer;
        public TreeRoot m_treeLocate;
        public TreeRoot m_treeSequence;
        public Siltron_Process(string id, IEngineer engineer, Siltron_Handler handler)
        {
            m_id = id;
            m_engineer = engineer;
            m_handler = handler;
