...
namespace Root_WIND2.Module
{
    public class Run_VisionAlign : ModuleRunBase
    {
        ...
        public override string Run()
        {
            ...
            //double realX = Math.Abs(m_firstPointPulse.X - m_secondPointPulse.X) / 10;
            //double cx = ((camWidth / 2) + resPosX) * m_AlignCamResolution;
            //double cy = m_firstPointPulse.Y / PULSE_TO_UM - ((camHeight / 2) + resPosY) * m_AlignCamResolution;

            //double cx2 = ((camWidth / 2) + resPosX2) * m_AlignCamResolution;
            //double cy2 = m_secondPointPulse.Y / PULSE_TO_UM - ((camHeight / 2) + resPosY2) * m_AlignCamResolution;
            double cx = m_firstPointPulse.X / PULSE_TO_UM - ((camWidth / 2) + resPosX) * m_AlignCamResolution;
            double cy = m_firstPointPulse.Y / PULSE_TO_UM - ((camHeight / 2) + resPosY) * m_AlignCamResolution;
            ...
            //if (m_module.Run(axisXY.p_axisX.StartMove(m_firstPointPulse.X - (resPosX - camWidth / 2) * m_AlignCamResolution * 10)))
            //    return p_sInfo;
            //if (m_module.Run(axisXY.p_axisX.WaitReady()))
            //    return p_sInfo;
            //if (m_module.Run(axisXY.p_axisY.StartMove(m_firstPointPulse.Y + (resPosY - camHeight / 2) * m_AlignCamResolution * 10)))
            //    return p_sInfo;
            //if (m_module.Run(axisXY.p_axisY.WaitReady()))
            //    return p_sInfo;
            //Axis axisRotate = m_module.AxisRotate;
            //axisRotate.StartMove((angle * 1000));
            //camWidth = 2200;
            //camHeight = 2200;
            ////resPosX = 0;
            ////resPosY = 2200;
