...
{
    /// <summary>
    /// JEDI_Sorter_Handler_UI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class JEDI_Sorter_Handler_UI : UserControl
    {
        public JEDI_Sorter_Handler_UI()
        {
            InitializeComponent();
        }

        JEDI_Sorter_Handler m_handler;
        public void Init(JEDI_Sorter_Handler handler)
        {
            m_handler = handler;
            DataContext = handler;
