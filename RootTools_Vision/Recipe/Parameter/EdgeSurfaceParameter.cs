...
namespace RootTools_Vision
{
	public class EdgeSurfaceParameter : ParameterBase, IMaskInspection, IColorInspection
	{
		...
		#region [Parameter]
		private int roiHeightTop = 1000;
		private int roiWidthTop = 3000;
		...
		//private int defectCodeTop = 0;

		private int roiHeightSide = 1000;
		private int roiWidthSide = 3000;
		...
		//private int defectCodeSide = 0;

		private int roiHeightBtm = 1000;
		private int roiWidthBtm = 3000;
		...
		[Category("Parameter")]
		public int DefectCodeTop
		{
			get => this.defectCodeTop;
			set
			{
				SetProperty<int>(ref this.defectCodeTop, value);
			}
		}
		*/
		...
		[Category("Parameter")]
		public int DefectCodeSide
		{
			get => this.defectCodeSide;
			set
			{
				SetProperty<int>(ref this.defectCodeSide, value);
			}
		}
		*/
		...
		[Category("Parameter")]
		public int DefectCodeBtm
		{
			get => this.defectCodeBtm;
			set
			{
				SetProperty<int>(ref this.defectCodeBtm, value);
			}
		}
		*/
