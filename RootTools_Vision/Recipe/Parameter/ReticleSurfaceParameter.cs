...
{
    public class ReticleSurfaceParameter : ParameterBase, IMaskInspection, IColorInspection, IBacksideInspection
    {
        public ReticleSurfaceParameter() : base(typeof(ReticleSurface))
        {
