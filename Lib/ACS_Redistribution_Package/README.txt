...
===============================================================================
      How to install the version 6.67.00.00 onto x86 operating system
===============================================================================
...
3. Rename the following files:
   ...
   wdapi1011.$dll to wdapi1011.dll

4. Copy ACSCSRV.EXE, ACS.EStop.exe, and wdapi1011.dll to the "User Mode Driver"
   directory (default C:\Program Files\ACS Motion Control\SPiiPlus ADK Suite v2.60
   \User Mode Driver) 
...
6. Copy SPiiPlusCOM660_x86.dll and ACS.SPiiPlusNET.dll to the "CommonFiles"
   directory (default C:\Program Files (x86)\ACS Motion Control\CommonFiles)
...
===============================================================================
      How to install the version 6.67.00.00 onto x64 operating system
===============================================================================
...
6. Copy ACSCSRV.EXE, ACS.EStop.exe, and wdapi1011.dll to the "User Mode Driver"
   directory (default C:\Program Files (x86)\ACS Motion Control
   \SPiiPlus ADK Suite v2.60\User Mode Driver) 
   directory and overwrite the previous file with the same name.
