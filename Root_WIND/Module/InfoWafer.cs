    ...
    public class InfoWafer : GemSlotBase
    {
        ...
        public double p_mmWaferSize
        {
            get
            {
                switch (p_eSize)
                {
                    case eWaferSize.e300mm:
                        ;
                        return 300;
                    case eWaferSize.e300mmRF:
                        return 300;
                    case eWaferSize.e200mm:
                        return 200;
                    case eWaferSize.e4inch:
                        return 100;
                    case eWaferSize.e5inch:
                        return 125;
                    case eWaferSize.e6inch:
                        return 150;
                    case eWaferSize.e8inch:
                        return 200;
                    default:
                        return 300;
                }
        ...
        void RunTreeRecipe(Tree tree)
        {
            ...
            if (sRecipe != m_sManualRecipe)
                RecipeOpen(m_sManualRecipe);
            if (m_moduleRunList != null)
                m_moduleRunList.RunTree(tree);
        }
        #endregion
