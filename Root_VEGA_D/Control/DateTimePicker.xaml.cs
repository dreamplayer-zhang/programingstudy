...
namespace Root_VEGA_D.Control
{
	...
	public partial class DateTimePicker : UserControl
	{
		...
		public string DateFormat
		{
			get
			{
				return Convert.ToString(GetValue(DateFormatProperty));
			}
			set
			{
		...
		public bool ShowCalendarButton
		{
			get
			{
				return PopUpCalendarButton.Visibility == Visibility.Visible;
			}
			set
			{
				PopUpCalendarButton.Visibility = (value ? Visibility.Visible : Visibility.Collapsed);
			}
		}
		...
		public DateTime MinimumDate
		{
			get
			{
				return Convert.ToDateTime(GetValue(MinimumDateProperty));
			}
			set
			{
		...
		public DateTime MaximumDate
		{
			get
			{
				return Convert.ToDateTime(GetValue(MaximumDateProperty));
			}
			set
			{
		...
		protected bool DateTextIsWrong
		{
			get
			{
				return (bool)GetValue(DateTextIsWrongProperty);
			}
			set
			{
				SetValue(DateTextIsWrongProperty, value);
			}
		}
	...
	public class TextBoxUpDownAdorner : Adorner
	{
		...
		public Pen Outline = new Pen(new SolidColorBrush(Color.FromArgb(100, 0, 0, 0)), 1);
		public Brush Fill = Brushes.DimGray;
