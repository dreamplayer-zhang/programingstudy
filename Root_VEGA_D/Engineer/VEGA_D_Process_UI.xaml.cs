...
{
    /// <summary>
    /// VEGA_D_Process_UI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class VEGA_D_Process_UI : UserControl
    {
        public VEGA_D_Process_UI()
        {
            InitializeComponent();
        }

        VEGA_D_Process m_process;
        public void Init(VEGA_D_Process process)
        {
            m_process = process;
