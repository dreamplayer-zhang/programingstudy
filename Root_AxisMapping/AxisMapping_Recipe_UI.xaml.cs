...
{
    /// <summary>
    /// AxisMapping_Recipe_UI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class AxisMapping_Recipe_UI : UserControl
    {
        public AxisMapping_Recipe_UI()
        {
            InitializeComponent();
        }

        AxisMapping_Recipe m_recipe;
        ModuleRunList m_moduleRunList;
        public void Init(AxisMapping_Recipe recipe)
        {
            m_recipe = recipe;
