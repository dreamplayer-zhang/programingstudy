...
{
    /// <summary>
    /// WindII_Handler_UI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class WindII_Handler_UI : UserControl
    {
        public WindII_Handler_UI()
        {
            InitializeComponent();
        }

        WindII_Handler m_handler;
        public void Init(WindII_Handler handler)
        {
            m_handler = handler;
            DataContext = handler;
