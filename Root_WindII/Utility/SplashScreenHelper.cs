                    ...
                    new System.Threading.ThreadStart(
                        delegate ()
                        {
                            SplashScreen.Dispatcher.Invoke(
                                ...
                                new Action(delegate ()
                                {
                                    ((SplashScreen_ViewModel)SplashScreen.DataContext).SplashScreenText = text;
                                    ((SplashScreen_ViewModel)SplashScreen.DataContext).SplashScreenBrush = brush;
                                }
                            ));
                    ...
                    new System.Threading.ThreadStart(
                        delegate ()
                        {
                            SplashScreen.Dispatcher.Invoke(
                                ...
                                new Action(delegate ()
                                {
                                    ((SplashScreen_ViewModel)SplashScreen.DataContext).SplashProgressValue = value;
                                }
                            ));
                            SplashScreen.Dispatcher.Invoke(DispatcherPriority.ApplicationIdle, new Action(() => { }));
                        }
