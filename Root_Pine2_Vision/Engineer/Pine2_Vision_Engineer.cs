...
{
    public class Pine2_Vision_Engineer : NotifyProperty, IEngineer
    {
        #region IEngineer
        ...
        public void RunTree(Tree.eMode mode)
        {
            ...
            m_handler.RunTreeSetup(m_treeRoot.GetTree("Handler"));
        ...
        public Pine2_Vision_Handler m_handler = new Pine2_Vision_Handler();
