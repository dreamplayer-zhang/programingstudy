...
{
    /// <summary>
    /// Pine2_Vision_Engineer_UI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class Pine2_Vision_Engineer_UI : UserControl
    {
        public Pine2_Vision_Engineer_UI()
        {
            InitializeComponent();
        }

        Pine2_Vision_Engineer m_engineer = null;
        public void Init(Pine2_Vision_Engineer engineer)
        {
            m_engineer = engineer;
