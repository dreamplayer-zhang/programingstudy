...
namespace Root_Vega.Module
{
    public class Vega : ModuleBase
    {
        ...
        void InitALID()
        {
            ...
            m_alidLED1FanAlarm= m_gaf.GetALID(this, "LED 1 Fan Alarm", "LED 1 Fan Alarm");
            m_alidLED2FanAlarm = m_gaf.GetALID(this, "LED 2 Fan Alarm", "LED 2 Fan Alarm");
        }
        #endregion
        ...
        protected override void RunThread()
        {
            ...
            m_alidLED1FanAlarm.Run(!m_di12chLED1FanAlarm.p_bIn, "Please Check 12Ch LED 1 Fan");
            m_alidLED2FanAlarm.Run(!m_di12chLED2FanAlarm.p_bIn, "Please Check 12Ch LED 2 Fan");
            #endregion
