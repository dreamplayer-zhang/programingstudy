...
namespace Root_Vega.Module
{
    public class SideVision : ModuleBase, IRobotChild
    {
        ...
        protected override void InitModuleRuns()
        {
            ...
            AddModuleRunList(new Run_GrabSpecimen(this), true, "Specimen Grab");
        }
        #region Run_Delay
        ...
        public class Run_SideVRSImageCapture : ModuleRunBase
        {
            ...
            public override string Run()
            {
                ...
                try
                {
                    ...
                    InspectionTarget eOldTarget = InspectionTarget.SideInspectionBottom;
        ...
        //-------------------------------------------------------------------
        #endregion
        #region Run_GrabSpecimen
        public class Run_GrabSpecimen : ModuleRunBase
        {
            //-------------------------------------------------------------------
            SideVision m_module;
            ...
            //-------------------------------------------------------------------
            public Run_GrabSpecimen(SideVision module)
            {
                m_module = module;
                InitModuleRun(module);
            }
