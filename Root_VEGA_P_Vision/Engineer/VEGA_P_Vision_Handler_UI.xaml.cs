...
{
    /// <summary>
    /// VEGA_P_Vision_Handler_UI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class VEGA_P_Vision_Handler_UI : UserControl
    {
        public VEGA_P_Vision_Handler_UI()
        {
            InitializeComponent();
        }

        VEGA_P_Vision_Handler m_handler;
        public void Init(VEGA_P_Vision_Handler handler)
        {
            m_handler = handler;
            DataContext = handler;
