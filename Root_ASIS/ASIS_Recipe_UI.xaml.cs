...
{
    /// <summary>
    /// ASIS_Recipe_UI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ASIS_Recipe_UI : UserControl
    {
        public ASIS_Recipe_UI()
        {
            InitializeComponent();
        }

        ASIS_Recipe m_recipe;
        ModuleRunList m_moduleRunList;
        public void Init(ASIS_Recipe recipe)
        {
            m_recipe = recipe;
