...
{
    /// <summary>
    /// Wind_Recipe_UI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class Wind_Recipe_UI : UserControl
    {
        public Wind_Recipe_UI()
        {
            InitializeComponent();
        }

        Wind_Recipe m_recipe;
        ModuleRunList m_moduleRunList;
        public void Init(Wind_Recipe recipe)
        {
            m_recipe = recipe;
