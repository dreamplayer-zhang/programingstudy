...
{
    /// <summary>
    /// ADI_IPU_Handler_UI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ADI_IPU_Handler_UI : UserControl
    {
        public ADI_IPU_Handler_UI()
        {
            InitializeComponent();
        }

        ADI_IPU_Handler m_handler;
        public void Init(ADI_IPU_Handler handler)
        {
            m_handler = handler;
            DataContext = handler;
