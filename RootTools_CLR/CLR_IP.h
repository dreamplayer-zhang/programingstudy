...
namespace RootTools_CLR
{
	...
	public:
		...
		static void Cpp_SubtractAbs_MotionEstimation(array<byte>^ pSrcImg, array<byte>^ pRefImg, array<byte>^ pDstImg, int nChipW, int nChipH, int nStride);
		static void Cpp_SubtractAbs_MotionEstimation(byte* pSrcImg, array<byte>^ pDstImg, int imgNum, int  nMemW, int  nMemH, List<Cpp_Point^>^ RefROILT, Cpp_Point^ CurROILT, int stride, int nROIW, int nROIH);
		static void Cpp_Subtract(array<byte>^ pSrcImg1, array<byte>^ pSrcImg2, array<byte>^ pDstImg, int  nMemW, int  nMemH);
		static void Cpp_Subtract_MotionEstimation(array<byte>^ pSrcImg, array<byte>^ pRefImg, array<byte>^ pDstImg, int nChipW, int nChipH, int nStride, bool isDark);
		static void Cpp_Subtract_MotionEstimation(byte* pSrcImg, array<byte>^ pDstImg, int imgNum, int  nMemW, int  nMemH, List<Cpp_Point^>^ RefROILT, Cpp_Point^ CurROILT, int stride, int nROIW, int nROIH, bool isDark);
