...
{
    /// <summary>
    /// EFEM_Recipe_UI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class EFEM_Recipe_UI : UserControl
    {
        public EFEM_Recipe_UI()
        {
            InitializeComponent();
        }

        EFEM_Recipe m_recipe;
        ModuleRunList m_moduleRunList;
        public void Init(EFEM_Recipe recipe)
        {
            m_recipe = recipe;
