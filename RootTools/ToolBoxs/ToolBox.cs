...
namespace RootTools.ToolBoxs
{
    public class ToolBox
    {
        ...
        public string GetDIO(ref DIO_I4O2 value, ModuleBase module, string id, string sFalse, string sTrue, bool bLog = true, bool bEnableRun = false)
        {
            if (value == null) value = new DIO_I4O2(m_toolDIO, module.p_id + "." + id, bLog ? module.m_log : null, bEnableRun, sFalse, sTrue);
            string sInfo = value.RunTree(module.m_treeRootTool.GetTree(id));
            if (sInfo != "OK") return sInfo;
            for (int n = 0; n < 4; n++) module.m_listDI.AddBit(value.m_aBitDI[n]);
        ...
        public string GetAxis(ref AxisXZ value, ModuleBase module, string id)
        {
            if (value == null) value = m_control.GetAxisXZ(module.p_id + "." + id, module.m_log);
            module.m_listAxis.Add(value.p_axisX);
