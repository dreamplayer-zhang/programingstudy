...
namespace RootTools.Control
{
    public class DIO_I8O2 : IDIO
    {
        ...
        public string m_id;
        Log m_log;
        public DIO_I8O2(IToolDIO tool, string id, Log log, bool bEnableRun, string sFalse, string sTrue)
        {
            ...
            m_asID.Add(sFalse);
            m_asID.Add(sTrue);
            for (int n = 0; n < 8; n++) m_aBitDI.Add(new BitDI());
        ...
        public string RunTree(Tree tree)
        {
            ...
            sDI[2] = RunTreeDI(tree, m_aBitDI[2], m_asID[0] + "2");
            sDI[3] = RunTreeDI(tree, m_aBitDI[3], m_asID[0] + "3");
            sDI[4] = RunTreeDI(tree, m_aBitDI[4], m_asID[1] + "0");
            sDI[5] = RunTreeDI(tree, m_aBitDI[5], m_asID[1] + "1");
            sDI[6] = RunTreeDI(tree, m_aBitDI[6], m_asID[1] + "2");
            sDI[7] = RunTreeDI(tree, m_aBitDI[7], m_asID[1] + "3");
