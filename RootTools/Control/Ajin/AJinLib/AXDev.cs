...
//======== PCI-R1604-MLII 전용 함수=========================================================================== 
    ...
    */
    ...
    [DllImport("AXL.dll")] public static extern uint AxlECatReadSdoEx(int lBoardNo, uint dwStationAddress, ushort wObjectIndex, byte byObjectSubIndex, ref byte pbyData, uint dwDataLength, ref uint pdwReadDataLength);
    ...
    [DllImport("AXL.dll")] public static extern uint AxlECatWriteSdoEx(int lBoardNo, uint dwStationAddress, ushort wObjectIndex, byte byObjectSubIndex, ref byte pbyData, uint dwDataLength);
